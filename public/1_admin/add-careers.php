<?php
	...
	if (isset($_POST['submit'])) {	        
        ...
        $sql = "INSERT INTO careers (title, overview, active) 
                VALUES ('$title', '$overview', '$active')";
...
<html>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Payrailz: Add Career</title>
    ...
    <body class="adminArea">
        ...
        <section id="insideContent" class="pb-0">
            <div id="adminContent"class="container">
                <h2 class="text-center">Admin: Add Career</h2>
                <hr class="pb-4">
                <form id="form1" name="form1" method="post" enctype="multipart/form-data" >                 
                    ...
                    <div class="row justify-content-center">
                        <div class="form-group col-8">
                            <h4>Overview:</h4> 
                            <textarea name="overview" cols="" rows="20" class="form-control" placeholder="OVERVIEW"></textarea>
                        </div>
                    </div>
